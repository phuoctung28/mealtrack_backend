...
class Settings(BaseSettings):
    ...
    WEB_FUNNEL_LEADS_ENABLED: bool = Field(default=False)
    WEB_FUNNEL_EMAIL_ENABLED: bool = Field(default=False)
    WEB_FUNNEL_EXCHANGE_ENABLED: bool = Field(default=False)
    WEB_FUNNEL_COMPLETE_ENABLED: bool = Field(default=False)
    WEB_FUNNEL_REVENUECAT_PRODUCT_IDS: str = Field(default="")
    WEB_FUNNEL_REVENUECAT_ENVIRONMENT: str = Field(default="")
    WEB_FUNNEL_REVENUECAT_PROJECT_ID: str = Field(default="")
    WEB_FUNNEL_REVENUECAT_APP_ID: str = Field(default="")
