"""Application-owned observability facade."""
...
_connector: ObservabilityConnector | None = None


def _build_default_connector() -> ObservabilityConnector:
    from src.infra.monitoring.sentry import SentryObservabilityConnector

    return SentryObservabilityConnector()
...
def get_observability_connector() -> ObservabilityConnector:
    ...
    if _connector is None:
        _connector = _build_default_connector()
    return _connector
...
def use_noop_observability() -> None:
    ...
    set_observability_connector_for_test(NoopObservabilityConnector())
