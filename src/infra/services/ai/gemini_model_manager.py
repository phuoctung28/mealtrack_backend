...
class GeminiModelManager:
    ...
    def __init__(self):
        ...
        if GeminiModelManager._instance is not None:
            raise RuntimeError("GeminiModelManager is a singleton. Use get_instance() instead.")
        ...
        if cls._instance is None:
            with cls._lock:
                ...
                if cls._instance is None:
                    ...
                    # Cache configuration
                    instance.max_cache_size = int(os.getenv("GEMINI_MAX_CACHE_SIZE", DEFAULT_MAX_CACHE_SIZE))
                    instance.ttl_seconds = int(os.getenv("GEMINI_CACHE_TTL", DEFAULT_TTL_SECONDS))
    ...
    def _evict_expired(self) -> int:
        ...
        expired_keys = [
            key for key, cached in self._models.items()
    ...
    def _evict_lru(self) -> Optional[str]:
        ...
        lru_key = min(
            self._models.keys(),
            key=lambda k: self._models[k].last_accessed
        )
