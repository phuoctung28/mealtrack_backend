        ...
        try:
            ...
            if not firebase_admin._apps:
                ...
                if service_account_key:
                    ...
                    logger.warning("No Firebase service account key found. Push notifications will be disabled.")
            else:
                ...
                for idx, result in enumerate(response.responses):
                    if not result.success:
                        failed_tokens.append({
                            "token": tokens[idx],
                            "error": result.exception.code if result.exception else "unknown_error"
                        })
