...
async def run() -> None:
    ...
    try:
        ...
        log_event(
            ...
            attributes={"phase": "push.precompute", "status": "success"},
        )
    except Exception as exc:
    ...
    try:
        ...
        log_event(
            "info",
            "cron.phase.completed",
            attributes={"phase": "push.trial", "status": "success"},
        )
    except Exception as exc:
    ...
    try:
        ...
        log_event(
            "info",
            "cron.phase.completed",
            attributes={"phase": "push.dispatch", "status": "success"},
        )
    except Exception as exc:
    ...
    try:
        ...
        log_event(
            "info",
            "cron.phase.completed",
            attributes={"phase": "push.cleanup", "status": "success"},
        )
    except Exception as exc:
