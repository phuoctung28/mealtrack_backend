...
class OnboardingSectionType(Enum):
    ...
    DAILY_LIFE = "DAILY_LIFE"  # Replaces ACTIVITY_LEVEL
    TRAINING_FREQUENCY = "TRAINING_FREQUENCY"  # Replaces ACTIVITY_LEVEL
    TRAINING_LEVEL = "TRAINING_LEVEL"  # Beginner/Intermediate/Advanced
