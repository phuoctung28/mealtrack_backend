...
class Activity:
    ...
    @classmethod
    def create_new(
        cls, activity_type: ActivityType, title: str, **kwargs
    ) -> "Activity":
    ...
    def create_manual_food_activity(cls, food_id: str, food_name: str) -> "Activity":
        ...
        return cls.create_new(
            ...
            metadata={"food_id": food_id, "food_name": food_name},
        )

    @classmethod
    def create_food_update_activity(
        cls, food_id: str, food_name: str, updated_fields: list
    ) -> "Activity":
