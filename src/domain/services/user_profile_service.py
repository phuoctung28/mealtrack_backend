...
class UserProfileService:
    ...
    def __init__(
        self, user_repo: UserRepositoryPort, tdee_service: TdeeCalculationService
    ):
    ...
    def create_user_preferences_from_data(
        self, data: Dict[str, Any], plan_duration: PlanDuration = PlanDuration.DAILY
    ) -> UserPreferences:
