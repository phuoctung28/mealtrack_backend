...
class RequestBuilder:
    ...
    def build_generation_request(
        ...
        user_profile = UserDietaryProfile(
            ...
            job_type=request_data.get("job_type", "desk"),
            training_days_per_week=request_data.get("training_days_per_week", 0),
            training_minutes_per_session=request_data.get("training_minutes_per_session", 60),
    ...
    def convert_request_to_dict(
        ...
        return {
            ...
            "job_type": generation_request.user_profile.job_type,
            "training_days_per_week": generation_request.user_profile.training_days_per_week,
            "training_minutes_per_session": generation_request.user_profile.training_minutes_per_session,
