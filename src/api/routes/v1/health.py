...
async def database_pool_status(_admin: str = Depends(require_admin)):
    """
...
async def db_connection_status(_admin: str = Depends(require_admin)):
    """
...
async def notification_health_check(_admin: str = Depends(require_admin)):
    """
