...
class BulkNutritionResponse(BaseModel):
    ...
    dates: Dict[str, DateSummary] = Field(
        ..., description="Date-indexed nutrition summaries"
    )
    weekly_budget: Optional[WeeklyBudgetSummary] = Field(
        None, description="Current week's budget"
    )
