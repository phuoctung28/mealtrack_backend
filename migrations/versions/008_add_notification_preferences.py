...
def upgrade() -> None:
    ...
    op.add_column('user_profiles', 
        sa.Column('push_notifications_enabled', sa.Boolean(), server_default='1', nullable=False))
    op.add_column('user_profiles', 
        sa.Column('email_notifications_enabled', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('user_profiles', 
        sa.Column('weekly_weight_reminder_enabled', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('user_profiles', 
