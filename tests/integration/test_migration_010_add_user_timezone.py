...
class TestMigration010:
    ...
    def test_notification_preferences_last_water_reminder_at_column_exists(
        self, test_session
    ):
    ...
    def test_notification_preferences_last_water_reminder_at_nullable(
        self, test_session
    ):
    ...
    def test_notification_preferences_last_water_reminder_at_can_be_set(
        self, test_session
    ):
