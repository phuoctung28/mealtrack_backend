...
MOCK_FEATURE_FLAGS_RESPONSE = {
    ...
    "flags": {"meal_planning": True, "activity_tracking": True},
...
class TestFeatureFlagsEndpoint:
    ...
    def test_meal_planning_flag_can_be_disabled(self):
        ...
        mock_response = {
            "environment": "application",
            "flags": {"meal_planning": False, "activity_tracking": True},
            "updated_at": "2024-08-31T12:00:00Z",
        }
    ...
    def test_get_individual_feature_flag_invalid_feature(self):
        ...
        # Mock 404 response
        mock_404_response = {"detail": "Feature flag 'nonexistent_feature' not found"}
...
class TestFeatureFlagsCRUD:
    ...
    def test_update_nonexistent_feature_flag(self):
        ...
        # Mock 404 response
        mock_404_response = {"detail": "Feature flag 'nonexistent' not found"}
