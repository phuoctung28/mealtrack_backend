...
class TestNotificationRepository:
    ...
    def test_save_new_fcm_token(self, repository, mock_db_session):
        ...
        # Patch the mapper function
        with patch(_FCM_MAPPER, return_value=token):
            # Act
    ...
    def test_find_active_fcm_tokens_by_user(self, repository, mock_db_session):
        ...
        # Patch the mapper function to return tokens in order
        with patch(_FCM_MAPPER, side_effect=[token1, token2]):
            # Act
    ...
    def test_save_new_notification_preferences(self, repository, mock_db_session):
        ...
        # Patch the mapper function
        with patch(_PREFS_MAPPER, return_value=prefs):
            # Act
