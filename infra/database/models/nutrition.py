...
class Macros(Base):
    ...
    def to_domain(self):
        ...
        from domain.model.macros import Macros as DomainMacros
...
class FoodItem(Base, BaseMixin):
    ...
    def to_domain(self):
        """Convert DB model to domain model."""
        from domain.model.nutrition import FoodItem as DomainFoodItem
...
class Nutrition(Base, BaseMixin):
    ...
    def to_domain(self):
        """Convert DB model to domain model."""
        from domain.model.nutrition import Nutrition as DomainNutrition
